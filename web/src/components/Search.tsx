...
const Search: React.FC<SearchProps> = ({ title, setTitle }) => {
  ...
  return (
    <header className="flex justify-between items-center mb-4 border-b border-opacity-15 border-slate pb-4">
      <h1 className="text-2xl font-bold text-white">Library</h1>
      <div className="flex items-center flex-grow justify-center px-40">
        <button
        ...
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <g mask="url(#mask0_1_1778)">
              <path d="M11.739 3.5C7.196 3.5 3.5 7.195 3.5 11.738C3.5 16.281 7.196 19.977 11.739 19.977C16.281 19.977 19.977 16.281 19.977 11.738C19.977 7.195 16.281 3.5 11.739 3.5ZM11.739 21.477C6.369 21.477 2 17.108 2 11.738C2 6.368 6.369 2 11.739 2C17.109 2 21.477 6.368 21.477 11.738C21.477 17.108 17.109 21.477 11.739 21.477Z" fill="#F7F5FF" />
            </g>
            <mask id="mask1_1_1778" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="17" y="17" width="6" height="6">
